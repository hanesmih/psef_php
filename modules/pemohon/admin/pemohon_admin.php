...
<script>
            ...
            "ajax": {
              ...
              "dataSrc": function ( json ) {
                ...
                for ( var i=0, ien=json.data.length; i<ien ; i++ ) {
                  ...
                  var actions = '<td><button onclick="view_data(\''+json.data[i].id+'\')" type="button" class="btn btn-xs btn-block waves-effect waves-light btn-info">Lihat Detail Data</button><button onclick="delete_data(\''+json.data[i].id+'\')" type="button" class="btn btn-xs btn-block waves-effect waves-light btn-danger">Hapus</button></td>';
                  datax.push(actions);
              ...
              "data": function ( d ) {
                ...
                data.fmodul = 'Pemohon';
                data.flsearch = 'name,email,phone,companyName,address';
                data.ftots = 5;
                return data;
              }
            }
    ...
    function delete_data(id){
        swal({
            title: 'Hapus Pemohon',
            text: "Apakah Anda yakin menghapus pemohon ini ?",
            type: 'warning',
