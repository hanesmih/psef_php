...
<script>
    ...
    $(document).ready(function() { 
        $('#zero_config').on('xhr.dt', function ( e, settings, json, xhr ) {
            ...
            "data": function ( d ) {
              return configurePermohonanRequest(d, 'Permohonan/DirekturPelayananFarmasiPending');
            }
            }
        });
    });
    ...
    function reject_data(id){
      permohonanKembalikan(id, url_api_x + 'Permohonan/DirekturPelayananFarmasiKembalikan', accesstoken);
    }

    function process_data(id){
      permohonanSetujui(id, url_api_x + 'Permohonan/DirekturPelayananFarmasiSetujui', accesstoken);
    }
</script>
