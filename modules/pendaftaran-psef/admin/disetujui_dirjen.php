...
$pageTitle = 'Permohonan (Disetujui Direktur Jenderal)';
        ...
        $('#zero_config').on('xhr.dt', function ( e, settings, json, xhr ) {
            ...
            "dataSrc": function ( json ) {
              ...
              for (let i = 0; i < json.data.length; i++) {
                ...
                let action = `<button onclick="view_data('${json.data[i].permohonanId}')" class="btn btn-xs btn-block btn-info">Lihat Detail Data</button>`;
            ...
            "data": function ( d ) {
              return configurePermohonanRequest(d, 'Permohonan/DirekturJenderalSelesai');
            }
            }
        });
    });
